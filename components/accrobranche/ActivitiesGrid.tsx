        ...
        <div className="relative mt-6 sm:mt-12">
                  ...
                  <div className="relative bg-white rounded-clay-lg shadow-clay flex flex-col h-full overflow-hidden">
                    ...
                    <div className="flex flex-col flex-1 px-5 pt-3 pb-6 text-center">
                      ...
                      <div className="flex justify-center">
                        <a
                          href={a.href}
                          className="group inline-flex items-center gap-3 pl-6 pr-2 py-2.5 rounded-full bg-lk-yellow text-[#3A2A00] font-fredoka font-extrabold text-sm shadow-clay-yellow transition-transform duration-300 hover:-translate-y-0.5 hover:scale-[1.03] active:scale-95"
                        >
                          Découvrir
                          <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#3A2A00] text-lk-yellow shadow-clay-inset transition-transform duration-300 group-hover:-rotate-45">
          ...
          <div className="lg:hidden flex justify-center gap-2 mt-8">
            {ACTIVITIES.map((_, i) => (
              <span
                key={i}
                className={`block h-1.5 rounded-full transition-all ${i === 0 ? "w-6 bg-lk-yellow" : "w-1.5 bg-gray-300"}`}
              />
            ))}
          </div>
        </div>
