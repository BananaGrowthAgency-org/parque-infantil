...
// Contenido inicial de la carte de Ludy'cafet. Se usa para sembrar carte.json
// la primera vez y como fallback cuando no hay Blob (dev/sin token). La edición
// ocurre in-place en /restauration (ver lib/restauration/store.ts).
export const CARTE_SEED: Categorie[] = [
  {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          { name: "Lulu", note: "(fraise ou chocolat)", price: "2,50 €" },
          { name: "Pepito", price: "2,80 €" },
          { name: "Mikado", price: "3,00 €" },
  ...
  },
  {
    ...
    shadow: "shadow-clay",
    infos: [
      { kind: "para", lead: "Wifi gratuite", text: ", le QR-code d'accès est disponible à l'accueil." },
      { kind: "para", lead: "Jeux de société", text: " disponibles à l'accueil (en échange d'une pièce d'identité)." },
      {
        kind: "para",
        lead: "Magazines à disposition et bibliothèque participative",
        text: " (donnez un livre, emmenez un livre).",
      },
      {
        kind: "heading",
        text: "Les règles importantes :",
        sub: "(le règlement intérieur est consultable à l'entrée du parc)",
      },
      {
        kind: "list",
        items: [
      ...
      {
        kind: "para",
        text: "Les enfants sont sous la responsabilité des adultes accompagnants, merci de leur rappeler qu'il est interdit de :",
      },
      {
        kind: "list",
        items: [
